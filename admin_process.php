...
// 4. COOKIE LOGIC: Check if user has already interacted
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="brandDrop" role="button" data-bs-toggle="dropdown">Explore Brands</a>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4">
                <div class="pepsi-card">
                    ...
                    <a href="brand_page.php?brand=<?php echo urlencode($row['brand_name']); ?>" class="btn btn-pepsi">Find Out More</a>
                </div>
            </div>
            <?php endwhile; endif; ?>
        </div>
...
<footer class="footer">
    ...
    <?php 
    // Updated to match your 'product_variations' table and 'brand_name' column
...
<?php 
// Final consolidated cookie logic
...
<div id="cookie-banner">
    ...
    <div class="d-flex align-items-center">
        <div class="cookie-btns">
            ...
            <button class="btn btn-manage btn-sm" onclick="acceptCookies()">Manage Preferences</button>
        </div>
...
<script>
    function acceptCookies() {
        ...
        // Tells the server to stop showing the banner
